...
class Doll:
    def __init__(self,action_point,attack_range,current_bullets,current_hp,effective_range,kind,gif_dic,magazine_capacity,max_damage,max_hp,min_damage,type,x,y):
...
class sangvisFerriDataManager(Doll):
    def __init__(self,action_point,attack_range,current_bullets,current_hp,effective_range,kind,gif_dic,magazine_capacity,max_damage,max_hp,min_damage,type,x,y,patrol_path):
        Doll.__init__(self,action_point,attack_range,current_bullets,current_hp,effective_range,kind,gif_dic,magazine_capacity,max_damage,max_hp,min_damage,type,x,y)
